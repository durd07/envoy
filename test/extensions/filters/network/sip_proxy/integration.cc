...
std::string BaseSipIntegrationTest::sip_config_;

void BaseSipIntegrationTest::preparePayloads(const PayloadOptions& options,
                                             Buffer::Instance& request_buffer,
                                             Buffer::Instance& response_buffer) {
  std::vector<std::string> args = {
      TestEnvironment::runfilesPath(
          "test/extensions/filters/network/sip_proxy/driver/generate_fixture.sh"),
      options.modeName(),
...
void BaseSipIntegrationTest::readAll(std::string file, Buffer::Instance& buffer) {
