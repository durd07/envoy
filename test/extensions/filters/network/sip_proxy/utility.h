...
inline envoy::extensions::filters::network::sip_proxy::v3::TransportType
transportTypeToProto(TransportType transport_type) {
  switch (transport_type) {
  case TransportType::Framed:
    return envoy::extensions::filters::network::sip_proxy::v3::FRAMED;
  case TransportType::Unframed:
    return envoy::extensions::filters::network::sip_proxy::v3::UNFRAMED;
  case TransportType::Header:
    return envoy::extensions::filters::network::sip_proxy::v3::HEADER;
  default:
    NOT_REACHED_GCOVR_EXCL_LINE;
  }
}

inline envoy::extensions::filters::network::sip_proxy::v3::ProtocolType
protocolTypeToProto(ProtocolType protocol_type) {
  switch (protocol_type) {
  case ProtocolType::Binary:
    return envoy::extensions::filters::network::sip_proxy::v3::BINARY;
  case ProtocolType::Compact:
    return envoy::extensions::filters::network::sip_proxy::v3::COMPACT;
  default:
    NOT_REACHED_GCOVR_EXCL_LINE;
  }
}
