...
public:
  SipSettings(std::chrono::milliseconds transaction_timeout, std::string own_domain,
              std::string domain_match_parameter_name, const envoy::extensions::filters::network::sip_proxy::tra::v3::TraServiceConfig & tra_service_config)
  ...
  envoy::extensions::filters::network::sip_proxy::tra::v3::TraServiceConfig& traServiceConfig() { return tra_service_config_; }
...
private:
  ...
  envoy::extensions::filters::network::sip_proxy::tra::v3::TraServiceConfig tra_service_config_;
};
